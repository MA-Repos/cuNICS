...
#include "../TeamOOPS_cuNICS/employeeinfo.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_employeeInfo_t, stringdata) + ofs \
...
void *employeeInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_employeeInfo.stringdata))
