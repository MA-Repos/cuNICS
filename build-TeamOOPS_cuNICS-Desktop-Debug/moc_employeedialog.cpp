...
#include "../TeamOOPS_cuNICS/employeedialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_EmployeeDialog_t, stringdata) + ofs \
...
const QMetaObject EmployeeDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EmployeeDialog.data,
      qt_meta_data_EmployeeDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *EmployeeDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EmployeeDialog.stringdata))
        return static_cast<void*>(const_cast< EmployeeDialog*>(this));
